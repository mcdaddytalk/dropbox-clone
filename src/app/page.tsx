    ...
    <main className="">
      <div className="flex flex-col lg:flex-row items-center bg-[#282929] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#282929] dark:bg-slate-800 text-white space-y-5">
          ...
          <p className="pb-20">Enhance your personal storage with Dropbox, offering simple and efficient way to upload, organize, and access files from anywhere.
          Securely store important documents and media, and experience the convenience of easy file management and sharing in one centralized solutions.</p>
          <Link 
            href={"/dashboard"}
        ...
        <div className="bg-[#1E1919] dark:db-slate-800">
